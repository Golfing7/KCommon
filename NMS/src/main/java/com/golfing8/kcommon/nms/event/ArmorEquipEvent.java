...
public class ArmorEquipEvent extends PlayerEvent {
    ...
    /**
     * Gets a list of handlers handling this com.golfing8.v1_19.event.
     *
    ...
    public enum EquipMethod{// These have got to be the worst documentations ever.
        ...
        SHIFT_CLICK,
        /**
         * When you drag and drop the com.golfing8.v1_19.item to equip or unequip
         */
        DRAG,
        /**
         * When you manually equip or unequip the com.golfing8.v1_19.item. Use to be DRAG
         */
        PICK_DROP,
        /**
         ...
         * Requires the spigot version to have {org.bukkit.com.golfing8.v1_19.event.com.golfing8.v1_19.block.BlockDispenseArmorEvent} implemented.
         */
        DISPENSER,
        /**
        ...
        DEATH,
        /**
         * This is a stand in for an "unknown" value. In actuality, this is only used for when we delegate the implementation to WineSpigot.
         */
        DELEGATED,
        ;
    }
