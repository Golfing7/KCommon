...
public class SkullCreator {
    ...
    public static ItemStack itemWithUuid(ItemStack item, UUID id) {
        ...
        SkullMeta meta = (SkullMeta) item.getItemMeta();
        NMS.getTheNMS().getMagicItems().setSkullOwningPlayer(meta, Bukkit.getOfflinePlayer(id));
        item.setItemMeta(meta);
    ...
    public static void blockWithName(Block block, String name) {
        ...
        NMS.getTheNMS().getMagicBlocks().setSkullOwner(state, Bukkit.getOfflinePlayer(name));
    ...
    public static void blockWithUuid(Block block, UUID id) {
        ...
        setToSkull(block);
        Skull state = (Skull) block.getState();
        NMS.getTheNMS().getMagicBlocks().setSkullOwner(state, Bukkit.getOfflinePlayer(id));
        state.update(false, false);
    }
